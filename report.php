...
<head>
    ...
    <!-- Title -->
    <title>CheckList - AGV - Relatórios</title>
            ...
            <div class="classy-nav-container breakpoint-off">
                ...
                <nav class="classy-navbar justify-content-between" id="uzaNav">
                    ...
                    <a class="nav-brand" href="index.php">
                        <h2>AGV CheckList - Relatórios</h2>
                    </a>
                            ...
                            <table>
                                ...
                                <tbody>
                                    ...
                                    <?php
                                      ...
                                      $pdo_verifica = $conexao_pdo->prepare("select codigo, tipo, alimentacao, otico, mecanico, fita, integridade, sinalizacao, conservacao, data from check_list ");
