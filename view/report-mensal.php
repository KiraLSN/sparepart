...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="AGV CheckList Mensal Report">
    ...
    <!-- Core Stylesheet -->
    <link rel="stylesheet" href="mensal-report.css">
            ...
            <div class="classy-nav-container breakpoint-off">
                ...
                <nav class="classy-navbar justify-content-between" id="uzaNav">
                    ...
                    <a class="nav-brand" href="index.php">
                        <br>
                        <h2>AGV CheckList</h2>
                        <h2>Relatório Mensal de <?=$strmes?></h2>
                    </a>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-4">
                    ...
                    <!-- Post Content -->
                    <button id="btnSend" name="btnSend" type="submit" class="btn uza-btn btn-3 mt-15"><a href="gera-mensal-pdf.php">Gerar PDF</a></button>
                            ...
                            <table>
                                ...
                                <tbody>
                                    ...
                                    <?php
                                      ...
                                      $pdo_verifica = $conexao_pdo->prepare("select codigo, tipo, alimentacao, otico, mecanico, fita, integridade, sinalizacao, conservacao, data from check_list WHERE month(data) = $mesatual order by data and codigo DESC ");
